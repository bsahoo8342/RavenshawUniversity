...
<body>
    ...
    <div class="head-design">
        ...
        <div class="text1"><a href="#">Recruitment</a></div>
    </div>

    <!-- body -->
    <div class="container-sm my-5">
        <ul>
            <li><a href="#">Guest Faculty advertisement-26.7.2022 <span class="text-animation">NEW</span></a></li>
            <li><a href="#">Application Form for Guest Faculty  <span class="text-animation">NEW</span></a></li>
            <li><a href="#">Engagement of Guest Faculty in Self Financing Department</a></li>
            <li><a href="#">Engagement of Guest Faculty in Regular Department</a></li>
        </ul>
